...
## SEC-001 — Code sandbox can read arbitrary host files incl. app secrets — **HIGH (security, isolation)** — DOCUMENTED (mitigation requires OS-level sandboxing)
