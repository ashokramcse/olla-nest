 ...
 * <p>
 * MCP servers extend the assistant with external tools. Registering,
 * connecting, and curating which of their tools are enabled is a privileged,
 * system-wide operation, so this controller is admin-gated. Connection
 * lifecycle and tool discovery are delegated to {@link McpServerService}.
 *
 * <h3>Design notes</h3>
 * <ul>
