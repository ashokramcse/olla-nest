 ...
 * <p>
 * Skills can be learned/proposed automatically and then need human review
 * before entering the shared library. This controller lets admins list,
 * approve, archive, and delete skills regardless of owner, complementing the
 * per-user {@code SkillsController}. The work is delegated to
 * {@link SkillsService}.
 *
 * <h3>Design notes</h3>
 * <ul>
...
public class AdminSkillsController extends BaseController {
	 ...
	 */
	@GetMapping
	public ResponseEntity<?> list(HttpServletRequest req, @RequestParam(required = false) String status) {
