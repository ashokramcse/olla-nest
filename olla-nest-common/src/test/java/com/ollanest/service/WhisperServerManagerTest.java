 ...
 *
 * <p>The manager spawns a daemon thread in its constructor and attempts to start
 * a Python subprocess. Unit tests only verify that construction succeeds and
 * that {@code stop()} is safe to call when no process was started (venv absent
 * in CI). No real processes are spawned or asserted.
 *
 * @author Ashok Ram
 * @since v2026.2.1
 * @version v2026.2.1
