 ...
 *
 * <p>Covers: {@code listAll()} — 7 system presets always present, correct IDs;
 * {@code createTemplate()} — DB INSERT, id prefix; {@code updateTemplate()} — DB UPDATE;
 * {@code deleteTemplate()} — scoped DELETE; {@code getTemplate()} — null when not found.
 *
