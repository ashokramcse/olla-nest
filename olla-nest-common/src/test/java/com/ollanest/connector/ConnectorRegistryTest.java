 ...
 *
 * <p>
 * Covers get() lookup by type key and types() list.
 *
 * @author Ashok Ram
 * @since v2026.2.1
 * @version v2026.2.1
...
class ConnectorRegistryTest {
	...
	class Get {
		...
		void setsDependencies() {
			...
			// Registry must inject shared dependencies into each connector at construction
			// time
	...
	class Types {
		...
		void containsAllTypes() {
			ConnectorRegistry registry = new ConnectorRegistry(
					List.of(mockConnector("github"), mockConnector("slack"), mockConnector("notion")), db, ragService,
					cryptoService);
		...
		void returnsSorted() {
			ConnectorRegistry registry = new ConnectorRegistry(
					List.of(mockConnector("slack"), mockConnector("github"), mockConnector("notion")), db, ragService,
					cryptoService);
