 ...
 *
 * <p>
 * All constants use placeholder credentials that are safe for test code.
...
public final class UserFactory {
	...
	public static final String BCRYPT_HASH = "$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVdtVBTelC";
	...
	/**
	 * Returns a raw JDBC row map representing the admin user (includes
	 * password_hash).
	 */
