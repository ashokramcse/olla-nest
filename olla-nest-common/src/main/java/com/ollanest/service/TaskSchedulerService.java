 ...
 * <h3>Design notes</h3>
 * <ul>
 * <li>The scheduler polling interval is 60 seconds; tasks whose {@code next_run}
 * timestamp has passed are selected and dispatched in virtual threads to prevent
 * a slow task from blocking subsequent ones.</li>
