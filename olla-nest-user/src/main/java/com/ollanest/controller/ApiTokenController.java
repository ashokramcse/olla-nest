 ...
 * <p>
 * Users need long-lived credentials to call the API from scripts and integrations
 * without going through the interactive session login flow. This controller lets
 * an authenticated user mint, enumerate, and revoke their own scoped tokens,
 * delegating all persistence and hashing to {@link ApiTokenService}.
 *
 * <h3>Design notes</h3>
 * <ul>
