...
public class NotesController extends BaseController {
	...
	/**
	 * Lists the calling user's notes, optionally filtered by archive state and
	 * label.
	 *
	 ...
	 */
	@GetMapping
	public ResponseEntity<?> list(HttpServletRequest req, @RequestParam(defaultValue = "false") boolean archived,
