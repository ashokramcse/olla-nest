 ...
 *
 * <p>
 * Handles direct URL access to the three application entry points:
 ...
 *
 * <p>
 * Without this controller, Spring MVC would return 404 for direct URL
 * navigation, breaking browser history navigation for the single-page frontend.
 *
 * <p>
 * <b>Design decisions:</b>
 * <ul>
 * <li>Uses {@code forward:/file.html} (not redirect) so the browser URL stays
 * at the clean path (e.g. {@code /app}) while Spring serves the HTML file from
 * the static directory.</li>
...
public class PageController extends BaseController {
	...
	/**
	 * Serves the admin login page. Redirects admins to {@code /admin} and non-admin
	 * authenticated users to {@code /app}.
	 *
