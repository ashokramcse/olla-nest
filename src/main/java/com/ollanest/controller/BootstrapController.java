 ...
 *
 * <p>GET {@code /api/bootstrap} is the first API call made by the browser on
 * page load. It returns:
 * <ul>
 ...
 * </ul>
 *
 * <p>This endpoint is intentionally unauthenticated. Since the security hardening
 ...
 * @version v2026.1.0  — security hardening: removed admin email from unauthenticated response (CRIT-6)
 */
@RestController
...
public class BootstrapController {
     ...
     *
     * <p>Queries the {@code users} table for the {@code u-admin} account's
     * password hash and BCrypt-checks it against the configured default password.
     * If the check passes, the admin has not yet changed the factory password and
     * {@code firstBoot} is set to {@code true}.
     *
     * <p>Never returns admin email, server paths, or any other sensitive data —
     * this endpoint is accessible without authentication.
     *
     * @return  200 OK with {@code {ready: true, firstBoot: boolean}}
     * @since   v2026.1.0  — initial Java Spring Boot migration
     * @version v2026.1.0  — security hardening: removed sensitive fields from response
     */
    @GetMapping
