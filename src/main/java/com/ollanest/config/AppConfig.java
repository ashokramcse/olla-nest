 ...
 *
 * <p>Defines the shared {@link ObjectMapper} singleton and exposes all
 ...
 *
 * <p>All values are bound from {@code application.properties} or environment
...
public class AppConfig {
    ...
    /**
     * Default admin password used on first-boot account creation.
     * AuthService replaces this with a random password if the default value
    ...
    /**
     * Produces the shared {@link ObjectMapper} bean used across all services
     * and controllers for JSON serialisation and deserialisation.
     *
     * <p>Configuration applied:
     * <ul>
     *   <li>{@link SerializationFeature#WRITE_DATES_AS_TIMESTAMPS} disabled
     *       so dates are emitted as ISO-8601 strings.</li>
     * </ul>
     *
    ...
    /**
     * Returns the default admin password for first-boot seeding.
     * This value is replaced by a random password at startup if unchanged.
     *
