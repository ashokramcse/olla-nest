 ...
 *
 * <p>Carries all enterprise access-control fields needed by the auth, routing, and
...
public class User {
    ...
    /**
     * Granular permission rights parsed from the JSON {@code rights} column,
     * e.g. {@code ["workspace:build", "model:use", "admin:users"]}.
     */
    ...
    /**
     * AI access tier controlling which models are visible to this user,
     * e.g. {@code "standard"}, {@code "premium"}, {@code "restricted"}.
     */
    ...
    /**
     * ISO-8601 timestamp after which login is denied, or {@code null} for
     * permanent access. Enforced by {@code AuthController} (HIGH-2 fix).
     */
    ...
    /** Authentication provider, e.g. {@code "local"}, {@code "ldap"}, {@code "saml"}. */
