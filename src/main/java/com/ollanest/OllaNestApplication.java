 ...
 *
 * <p>Bootstraps the entire application context via
 ...
 * <ul>
 *   <li>Scheduling is enabled at the application level rather than per-service
 *       to keep the scheduled annotation processing in a single, predictable
 *       location.</li>
 * </ul>
 *
 * @author  Ashok Ram
...
public class OllaNestApplication {
     ...
     *
     * <p>Delegates directly to {@link SpringApplication#run} which boots the
     * embedded Tomcat server, initialises the Spring context, runs
     * {@code DatabaseService}'s {@code @PostConstruct} pragmas, and starts all
     * scheduled tasks.
     *
